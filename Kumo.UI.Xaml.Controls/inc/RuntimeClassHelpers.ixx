...
struct ReferenceTracker : public ImplT<D, I ..., ::IReferenceTrackerExtension>, public ITrackerHandleManager
{
    ...
    int32_t __stdcall NonDelegatingQueryInterface(winrt::guid const& riid, void** value) noexcept
    {
        ...
        if (riid == winrt::guid_of<winrt::impl::IWeakReferenceSource>() && this->m_inner)
        {
        ...
        else
        {
            ...
            if (InlineIsEqualGUID(reinterpret_cast<GUID const&>(riid), __uuidof(::IReferenceTrackerExtension)) && !this->outer())
            {
