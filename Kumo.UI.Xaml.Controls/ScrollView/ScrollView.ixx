...
#include "ScrollBarController.ixx"
#include "ScrollViewTrace.ixx"
#include "ScrollView.g.h"
#include "ScrollView.properties.ixx"
...
public:
    ...
    static const winrt::Kumo::UI::Xaml::Controls::ScrollingScrollBarVisibility s_defaultHorizontalScrollBarVisibility{ winrt::Kumo::UI::Xaml::Controls::ScrollingScrollBarVisibility::Auto };
    static const winrt::Kumo::UI::Xaml::Controls::ScrollingScrollBarVisibility s_defaultVerticalScrollBarVisibility{ winrt::Kumo::UI::Xaml::Controls::ScrollingScrollBarVisibility::Auto };
...
private:
    ...
    void UpdateScrollPresenterProperties();
    ...
    struct AutoHideScrollBarsStateDeleter
    {
        void operator()(AutoHideScrollBarsState* state) const noexcept;
    };
    using AutoHideScrollBarsStatePtr = std::unique_ptr<AutoHideScrollBarsState, AutoHideScrollBarsStateDeleter>;
    static AutoHideScrollBarsStatePtr MakeAutoHideScrollBarsState();
    AutoHideScrollBarsStatePtr m_autoHideScrollBarsState = MakeAutoHideScrollBarsState();
