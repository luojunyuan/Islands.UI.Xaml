...
#include "FocusHelper.ixx"
#include "RegUtil.ixx"
#ifdef DBG
#include "ScrollViewTestHooks.ixx"
#endif
...
void ScrollView::AutoHideScrollBarsStateDeleter::operator()(AutoHideScrollBarsState* state) const noexcept
{
    delete state;
}
    
ScrollView::AutoHideScrollBarsStatePtr ScrollView::MakeAutoHideScrollBarsState()
{
    return AutoHideScrollBarsStatePtr{ new AutoHideScrollBarsState{} };
}
