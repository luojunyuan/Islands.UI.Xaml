...
namespace MUXControlsTestApp
{
    public sealed partial class ScrollViewDynamicPage : TestPage
    {
            ...
            try
            {
                ...
                switch (co)
                {
                    case ScrollingContentOrientation.Horizontal:
                        ...
                        wuxScrollViewer.VerticalScrollBarVisibility = Kumo.UI.Xaml.Controls.ScrollBarVisibility.Disabled;
                        break;
                    case ScrollingContentOrientation.Vertical:
                        wuxScrollViewer.HorizontalScrollBarVisibility = Kumo.UI.Xaml.Controls.ScrollBarVisibility.Disabled;
        ...
        private Kumo.UI.Xaml.Controls.ScrollBarVisibility MuxScrollBarVisibilityToWuxScrollBarVisibility(ScrollingScrollBarVisibility muxScrollBarVisibility)
        {
            switch (muxScrollBarVisibility)
            {
                case ScrollingScrollBarVisibility.Auto:
                    return Kumo.UI.Xaml.Controls.ScrollBarVisibility.Auto;
                case ScrollingScrollBarVisibility.Hidden:
                    return Kumo.UI.Xaml.Controls.ScrollBarVisibility.Hidden;
                default:
                    return Kumo.UI.Xaml.Controls.ScrollBarVisibility.Visible;
            }
        }

        private Kumo.UI.Xaml.Controls.ScrollMode MuxScrollModeToWuxScrollMode(ScrollingScrollMode muxScrollMode)
        {
            switch (muxScrollMode)
            {
                case ScrollingScrollMode.Disabled:
                    return Kumo.UI.Xaml.Controls.ScrollMode.Disabled;
                default:
                    return Kumo.UI.Xaml.Controls.ScrollMode.Enabled;
            }
        }

        private Kumo.UI.Xaml.Controls.ZoomMode MuxZoomModeToWuxZoomMode(ScrollingZoomMode muxZoomMode)
        {
            switch (muxZoomMode)
            {
                case ScrollingZoomMode.Disabled:
                    return Kumo.UI.Xaml.Controls.ZoomMode.Disabled;
                default:
                    return Kumo.UI.Xaml.Controls.ZoomMode.Enabled;
            }
        }
