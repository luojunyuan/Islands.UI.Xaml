...
using ScrollBarVisibility = Kumo.UI.Xaml.Controls.ScrollingScrollBarVisibility;
using ScrollPresenter = Kumo.UI.Xaml.Controls.Primitives.ScrollPresenter;
using ScrollingContentOrientation = Kumo.UI.Xaml.Controls.ScrollingContentOrientation;
using ScrollingScrollMode = Kumo.UI.Xaml.Controls.ScrollingScrollMode;
using ScrollingInputKinds = Kumo.UI.Xaml.Controls.ScrollingInputKinds;
using ScrollingChainMode = Kumo.UI.Xaml.Controls.ScrollingChainMode;
using ScrollingRailMode = Kumo.UI.Xaml.Controls.ScrollingRailMode;
using ScrollingZoomMode = Kumo.UI.Xaml.Controls.ScrollingZoomMode;
using ScrollingAnchorRequestedEventArgs = Kumo.UI.Xaml.Controls.ScrollingAnchorRequestedEventArgs;
