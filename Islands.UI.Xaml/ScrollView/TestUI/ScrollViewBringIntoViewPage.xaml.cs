...
using ScrollingBringingIntoViewEventArgs = Islands.UI.Xaml.Controls.ScrollingBringingIntoViewEventArgs;
...
{
    public sealed partial class ScrollViewBringIntoViewPage
    {
