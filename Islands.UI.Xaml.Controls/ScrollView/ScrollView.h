...
public:
    ...
    static const winrt::Islands::UI::Xaml::Controls::ScrollingScrollBarVisibility s_defaultHorizontalScrollBarVisibility{ winrt::Islands::UI::Xaml::Controls::ScrollingScrollBarVisibility::Auto };
    static const winrt::Islands::UI::Xaml::Controls::ScrollingScrollBarVisibility s_defaultVerticalScrollBarVisibility{ winrt::Islands::UI::Xaml::Controls::ScrollingScrollBarVisibility::Auto };
