...
)
{
    ...
    if (dependencyObject)
    {
        com_ptr<winrt::impl::abi<winrt::Windows::UI::Xaml::IDependencyObject>::type> dependencyObjectAbi;
        HRESULT hr = dependencyObject.as<::IUnknown>()->QueryInterface(winrt::impl::guid_v<winrt::Windows::UI::Xaml::IDependencyObject>, dependencyObjectAbi.put_void());
